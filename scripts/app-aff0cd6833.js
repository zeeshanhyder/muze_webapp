  ...
  authCheck.$inject = ["$rootScope", "locationService", "$state"];
...
(function(){
  ...
  HeaderController.$inject = ["$scope", "locationService", "$state"];
  angular.module('muze')
  .component('appHeader',{
    bindings: {
      props: '='
...
//# sourceMappingURL=../maps/scripts/app-aff0cd6833.js.map
